      ...
      000008                        503 	.ds	1
                                    ...
                                    546 ;--------------------------------------------------------
                                    547 	.area HOME    (CODE)
      000000                        548 __interrupt_vect:
      000000 02 00 06         [24]  549 	ljmp	__sdcc_gsinit_startup
                                    550 ;--------------------------------------------------------
      ...
      00005F 02 00 03         [24]  564 	ljmp	__sdcc_program_startup
                                    565 ;--------------------------------------------------------
                                    566 ; Home
                                    567 ;--------------------------------------------------------
                                    568 	.area HOME    (CODE)
                                    569 	.area HOME    (CODE)
      000003                        570 __sdcc_program_startup:
      000003 02 00 62         [24]  571 	ljmp	_main
      ...
      000062                        584 _main:
                           ...
                           000001   591 	ar1 = 0x01
                           000000   592 	ar0 = 0x00
                                    593 ;	main.c:6: while (1) 
      000062                        594 00102$:
                                    595 ;	main.c:10: }
      000062 80 FE            [24]  596 	sjmp	00102$
                                    597 	.area CSEG    (CODE)
                                    598 	.area CONST   (CODE)
                                    599 	.area XINIT   (CODE)
